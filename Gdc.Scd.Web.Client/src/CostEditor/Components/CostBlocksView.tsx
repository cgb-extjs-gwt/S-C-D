import { ComboBoxField, Container, ContainerField, FormPanel, Label, Panel, RadioField } from '@extjs/ext-react';
import * as React from 'react';
import { NamedId, SelectList } from '../../Common/States/CommonStates';
import { CheckItem, EditItem } from '../States/CostBlockStates';
import { EditGridTool, EditGridToolActions, EditGridToolProps } from './EditGridTool';
...
export class CostBlockView extends React.Component<CostBlockProps & CostBlockActions> {
    ...
    private onRegionSelected(combobox, newValue: string, oldValue) {
        if (typeof newValue === 'number') {
            ...
            combobox.getStore().filter('name', newValue); //find item in combo
        }
    }
