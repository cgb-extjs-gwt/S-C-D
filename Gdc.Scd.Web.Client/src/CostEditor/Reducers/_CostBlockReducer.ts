...
// import { CostBlockState, CostElementState, InputLevelState, CheckItem, EditItem, CostBlockEditState, DataLoadingState } from "../States/CostBlockStates";
...
//         ? {
//             ...state,
//             costBlocks: filterCostEditorItems(costBlockMetas).map(costBlockMeta => (<CostBlockState>{
