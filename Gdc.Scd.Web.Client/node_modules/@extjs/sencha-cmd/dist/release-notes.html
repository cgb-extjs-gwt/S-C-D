...
<div id="releases">
    ...
    -->
    <div class="release">
        <h1>Release Notes for Sencha Cmd 6.5.3</h1>
        <div class="notes">
            Date: January 16, 2018<br>
            Version Number: 6.5.3.6<br>
            <div class="platforms">
                ...
                <div class="installers win win32 win64">
                    <a class="jre64" href="../6.5.3.6/jre/SenchaCmd-6.5.3.6-windows-64bit.zip">64-bit</a>
                    <a class="jre32" href="../6.5.3.6/jre/SenchaCmd-6.5.3.6-windows-32bit.zip">32-bit</a><span class="alt">
                    <a class="nojre" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-windows-no_jre.zip">no_jre</a>
                    <a class="zip" href="../6.5.3.6/zip/SenchaCmd-6.5.3.6-windows.zip">zip</a></span>
                </div>
                <br/>
                <div class="disable-selection expandable collapsed platform mac" onclick="toggleAlt(this)">Mac OS X:
                    ...
                    <a class="jre" href="../6.5.3.6/jre/SenchaCmd-6.5.3.6-osx.app.zip">app</a><span class="alt">
                    <a class="nojre" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-osx-no_jre.app.zip">no_jre</a>
                    <a class="zip" href="../6.5.3.6/zip/SenchaCmd-6.5.3.6-osx.zip">zip</a></span>
                </div>
                <br />
                <div class="disable-selection platform linux">
                    ...
                    <div class="installers linux32">
                        <a class="sh" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-i386.sh.zip">sh</a><span class="alt">
                        <a class="deb" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-i386.deb">deb</a>
                        <a class="rpm" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-i386.rpm">rpm</a>
                        <a class="zip" href="../6.5.3.6/zip/SenchaCmd-6.5.3.6-linux-i386.zip">zip</a></span>
                    </div>
                    <br/>
                    ...
                    <div class="installers linux64">
                        <a class="sh" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-amd64.sh.zip">sh</a><span class="alt">
                        <a class="deb" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-amd64.deb">deb</a>
                        <a class="rpm" href="../6.5.3.6/no-jre/SenchaCmd-6.5.3.6-linux-amd64.rpm">rpm</a>
                        <a class="zip" href="../6.5.3.6/zip/SenchaCmd-6.5.3.6-linux-amd64.zip">zip</a></span>
                    </div>
                </div>
                <br/>
                <div class="options">
