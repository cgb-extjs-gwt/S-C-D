...
namespace Gdc.Scd.Import.Logistics
{
    public static class ImportConstants
    {
        ...
        public static string END_PROCESS = "Logistics Import Process has been finished";
        public static string UNEXPECTED_ERROR = "Logistics Import completed unsuccessfully. Please find details below.";
