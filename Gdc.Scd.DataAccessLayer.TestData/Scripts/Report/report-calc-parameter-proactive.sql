...
set @index = @index + 1;
insert into Report.ReportColumn(ReportId, [Index], TypeId, Name, Text, AllowNull, Flex) values(@reportId, @index, Report.GetReportColumnTypeByName('money'), 'CentralSetup', 'Setup Central Remote-Access & AutoCall', 1, 1);
set @index = @index + 1;
