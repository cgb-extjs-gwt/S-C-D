...
namespace Gdc.Scd.Import.Ebis.InstallBase
{
    public static class ImportConstants
    {
        ...
        public static string END_PROCESS = "Ebis: InstallBase Import Process has been finished";
        public static string UNEXPECTED_ERROR = "Ebis: InstallBase Import completed unsuccessfully. Please find details below.";
