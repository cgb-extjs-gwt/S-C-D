...
insert into Report.ReportPart(ReportId, PartId, [Index]) values((select Id from Report.Report where upper(Name) = 'LOCAP'), @stdw, 1);
insert into Report.ReportPart(ReportId, PartId, [Index]) values((select Id from Report.Report where upper(Name) = 'LOCAP-APPROVED'), @stdw, 1);
