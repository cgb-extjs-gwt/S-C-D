...
{
    public class Migration_2020_02_19_17_28 : IMigrationAction
    {
        private readonly IRepositorySet repositorySet;

        public int Number => 157;

        public string Description => "'ServiceSupportCost' calculation improvment ('SAR')";

        public Migration_2020_02_19_17_28(IRepositorySet repositorySet)
        {
        ...
        public void Execute()
        {
            ...
            this.repositorySet.ExecuteSql(@"DROP FUNCTION [Hardware].[CalcServiceSupportCost]");
