...
{
    public class Migration_2020_04_08_18_15 : IMigrationAction
    {
        private readonly IRepositorySet repositorySet;

        public int Number => 77777;

        public string Description => "Upload to SAP";

        public Migration_2020_04_08_18_15(IRepositorySet repositorySet)
        {
...
CREATE TABLE [dbo].[SapExportLog] 
(
	[Id] [bigint] IDENTITY(1,1) NOT NULL,
	[DateTime] [datetime2](7) NOT NULL,
	[ExportType] [int] NOT NULL,
	CONSTRAINT [PK_SapExportLog] PRIMARY KEY CLUSTERED 
	(
		[Id] ASC
	)
)");
