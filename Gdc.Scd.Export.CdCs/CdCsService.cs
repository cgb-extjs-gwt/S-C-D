...
namespace Gdc.Scd.Export.CdCs
{
    public class CdCsService
    {
        ...
        protected virtual void FillCdCs(Stream excel, List<SlaDto> slaList)
        {
            ...
            {
                FillCdCs(excel, slaList, config);
            }
        }

        protected virtual void FillCdCs(Stream excel, List<SlaDto> slaList, CdCsConfiguration config)
        {
