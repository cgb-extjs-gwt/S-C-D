namespace Gdc.Scd.Import.Ebis.Afr
{
    public static class ImportConstants
    {
        ...
        public const string END_PROCESS = "Ebis: AFR Import Process has been finished";
        public const string UNEXPECTED_ERROR = "Ebis: AFR Import completed unsuccessfully. Please find details below.";
