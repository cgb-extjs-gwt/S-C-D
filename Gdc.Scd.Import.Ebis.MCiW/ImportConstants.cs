...
namespace Gdc.Scd.Import.Ebis.MCiW
{
    public static class ImportConstants
    {
        ...
        public static string END_PROCESS = "Ebis: MaterialCost Import Process has been finished";
        public static string UNEXPECTED_ERROR = "Ebis: MaterialCost Import completed unsuccessfully. Please find details below.";
