...
namespace Gdc.Scd.Import.ExchangeRatesJob
{
    public class ImportConstants
    {
        ...
        public static string END_PROCESS = "Exchange Rates Import Process has been finished";
        public static string UNEXPECTED_ERROR = "Exchange Rates Import completed unsuccessfully. Please find details below.";
