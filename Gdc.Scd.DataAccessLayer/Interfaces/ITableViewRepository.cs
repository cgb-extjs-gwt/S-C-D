...
namespace Gdc.Scd.DataAccessLayer.Interfaces
{
    ...
    {
        Task<DataInfo<TableViewRecord>> GetRecords(TableViewCostBlockInfo[] tableViewInfos, QueryInfo queryInfo, IDictionary<ColumnInfo, IEnumerable<object>> filter = null);
