...
//        public (bool, List<SwDigit>, List<SwDigit>) UploadSwDigits(IDictionary<string, SCD2_SW_Overview> swInfo,
//            IEnumerable<Sog> sogs,
//            DateTime modifiedDateTime, List<UpdateQueryOption> updateOptions)
//        {
//            bool result = true;
//            List<SwDigit> noviceItems;
//            List<SwDigit> updatedItems;
...
//                var (allItems, newItems) = this.Add(updatedSwDigits, modifiedDateTime, updateOptions);

//                foreach (var addedEntity in allItems)
//                {
//                    _logger.Debug(PorImportLoggingMessage.ADDED_OR_UPDATED_ENTITY,
//                        nameof(SwDigit), addedEntity.Name);
//                }
//                //todo correct 2020-10-06
//                noviceItems = newItems;
//                updatedItems = (List<SwDigit>)allItems.Except(newItems);
//                //novice = added;
//                _logger.Info(PorImportLoggingMessage.ADD_STEP_END, allItems.Count);
//            }
...
//                updatedItems = null;
//            }
//            return (result, noviceItems, updatedItems);
//        }
//    }
//}
